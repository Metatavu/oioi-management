...
import { Application, ApplicationFromJSON, ApplicationToJSON, ErrorResponse, ErrorResponseFromJSON, ErrorResponseToJSON } from "../models";
...
export class ApplicationsApi extends runtime.BaseAPI {
  ...
  async createApplicationRaw(requestParameters: CreateApplicationRequest): Promise<runtime.ApiResponse<Application>> {
    ...
    const response = await this.request({
      path: `/customers/{customerId}/devices/{deviceId}/applications`
        .replace(`{${"customerId"}}`, encodeURIComponent(String(requestParameters.customer_id)))
        .replace(`{${"deviceId"}}`, encodeURIComponent(String(requestParameters.device_id))),
      method: "POST",
  ...
  async deleteApplicationRaw(requestParameters: DeleteApplicationRequest): Promise<runtime.ApiResponse<void>> {
    ...
    if (requestParameters.application_id === null || requestParameters.application_id === undefined) {
      throw new runtime.RequiredError(
        "application_id",
        "Required parameter requestParameters.application_id was null or undefined when calling deleteApplication."
      );
    }
    ...
    const response = await this.request({
      path: `/customers/{customerId}/devices/{deviceId}/applications/{applicationId}`
        .replace(`{${"customerId"}}`, encodeURIComponent(String(requestParameters.customer_id)))
        .replace(`{${"deviceId"}}`, encodeURIComponent(String(requestParameters.device_id)))
        .replace(`{${"applicationId"}}`, encodeURIComponent(String(requestParameters.application_id))),
      method: "DELETE",
      headers: headerParameters,
      query: queryParameters
    });
  ...
  async findApplicationRaw(requestParameters: FindApplicationRequest): Promise<runtime.ApiResponse<Application>> {
    ...
    if (requestParameters.application_id === null || requestParameters.application_id === undefined) {
      throw new runtime.RequiredError(
        "application_id",
        "Required parameter requestParameters.application_id was null or undefined when calling findApplication."
      );
    }
  ...
  async updateApplicationRaw(requestParameters: UpdateApplicationRequest): Promise<runtime.ApiResponse<Application>> {
    ...
    if (requestParameters.application_id === null || requestParameters.application_id === undefined) {
      throw new runtime.RequiredError(
        "application_id",
        "Required parameter requestParameters.application_id was null or undefined when calling updateApplication."
      );
    }
